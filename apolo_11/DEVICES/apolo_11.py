...
class Apolo_11:
    """
        Esta clase es la consolidará y generará los atributos y métodos necesarios para los datos de los reportes
    """
    def __init__(self,mision_instancia,dispositivos_instancia):
        self.date = fecha_solicitada()
        
        # OJO IF MISSION = KNOW ENTONCES LLENO LOS OTROS DATOS OJOOOOOO
        self.mission = mision_instancia
        self.device_type = dispositivos_instancia
